...
import com.must.api.api.ApiConfig;
import com.must.api.model.AddMahasiswaResponse;
    ...
    private void addDataMahasiswa() {
        ...
        if (nrp.isEmpty() || nama.isEmpty() ||
            ...
            Call<AddMahasiswaResponse> client =
                    ApiConfig.getApiService().addMahasiswa(nrp, nama, email, jurusan);
